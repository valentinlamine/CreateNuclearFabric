...
public class CNItems {
    ...
    public static final Item ANTI_RADIATION_HELMET = registerItem("anti_radiation_helmet", new DyeableArmorItem(CNArmorMaterials.ANTI_RADIATION_SUIT, ArmorItem.Type.HELMET, new FabricItemSettings()));
    public static final Item ANTI_RADIATION_CHESTPLATE = registerItem("anti_radiation_chestplate", new DyeableArmorItem(CNArmorMaterials.ANTI_RADIATION_SUIT, ArmorItem.Type.CHESTPLATE, new FabricItemSettings()));
    public static final Item ANTI_RADIATION_LEGGINGS = registerItem("anti_radiation_leggings", new DyeableArmorItem(CNArmorMaterials.ANTI_RADIATION_SUIT, ArmorItem.Type.LEGGINGS, new FabricItemSettings()));
