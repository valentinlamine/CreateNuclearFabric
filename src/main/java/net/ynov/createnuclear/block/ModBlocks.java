...
public class ModBlocks {
    ...
    public static final Block ENRICHING_FLAME = registerBlock("enriching_flame", new FireBlock(BlockBehaviour.Properties.of().mapColor(MapColor.FIRE).replaceable().noCollission().instabreak().lightLevel(state -> 15).sound(SoundType.WOOL).pushReaction(PushReaction.DESTROY)));
