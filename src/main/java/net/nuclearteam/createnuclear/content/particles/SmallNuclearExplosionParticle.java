...
public class SmallNuclearExplosionParticle extends TextureSheetParticle {
    ...
    protected SmallNuclearExplosionParticle(ClientLevel world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, SpriteSet sprites, boolean shortLifespan, int color1) {
        ...
        this.setColor(Math.min(FastColor.Argb.getRed(color1) / 255F + randCol, 1), Math.min(1F, FastColor.Argb.getGreen(color1) / 255F + randCol), Math.min(1F, FastColor.Argb.getBlue(color1) / 255F + randCol));
    }
    ...
    public static class ConversionCrucibleFactory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            SmallNuclearExplosionParticle particle = new SmallNuclearExplosionParticle(worldIn, x, y, z, 0.0D, 0.0D, 0.0D, spriteSet, true, FastColor.Argb.getArgb(255, (int)(255F * xSpeed), (int)(255F * ySpeed), (int)(255F * zSpeed)));
            particle.setSpriteFromAge(spriteSet);
            particle.scale(0.8F);
            particle.setFadeColor(0XFFFFFF);
            return particle;
