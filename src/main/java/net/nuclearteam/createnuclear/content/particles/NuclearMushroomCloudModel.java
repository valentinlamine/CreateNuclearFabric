...
import net.nuclearteam.createnuclear.content.explosion.CNAdvancedEntityModel;
import net.nuclearteam.createnuclear.content.explosion.CNAdvancedModelBox;
import net.nuclearteam.createnuclear.content.explosion.CNBasicModelPart;

public class NuclearMushroomCloudModel extends CNAdvancedEntityModel {
    private final CNAdvancedModelBox mushroom_cloud;
    private final CNAdvancedModelBox lightBall;
    private final CNAdvancedModelBox lowerCloud;
    private final CNAdvancedModelBox lowerCloud_planes;
    private final CNAdvancedModelBox cube_r1;
    private final CNAdvancedModelBox cube_r2;
    private final CNAdvancedModelBox cube_r3;
    private final CNAdvancedModelBox cube_r4;
    private final CNAdvancedModelBox plume;
    private final CNAdvancedModelBox cube_r5;
    private final CNAdvancedModelBox cube_r6;
    private final CNAdvancedModelBox plumeBlast;
    private final CNAdvancedModelBox plumeRing;
    private final CNAdvancedModelBox upperCloud;
    private final CNAdvancedModelBox upperCloud1;
    private final CNAdvancedModelBox upperCloud_planes;
    private final CNAdvancedModelBox cube_r7;
    private final CNAdvancedModelBox cube_r8;
    private final CNAdvancedModelBox cube_r9;
    private final CNAdvancedModelBox cube_r10;
    private final CNAdvancedModelBox rings;
    private final CNAdvancedModelBox upperRing;
    private final CNAdvancedModelBox lowerRing;

    public NuclearMushroomCloudModel() {
        texWidth = 512;
        texHeight = 512;

        mushroom_cloud = new CNAdvancedModelBox(this);
        mushroom_cloud.setRotationPoint(0.0F, 24.0F, 0.0F);


        lightBall = new CNAdvancedModelBox(this);
        ...
        lowerCloud = new CNAdvancedModelBox(this);
        ...
        cube_r2 = new CNAdvancedModelBox(this);
        ...
        cube_r3 = new CNAdvancedModelBox(this);
        ...
        cube_r4 = new CNAdvancedModelBox(this);
        ...
        plume = new CNAdvancedModelBox(this);
        plume.setRotationPoint(0.0F, 9, 0.0F);
        lightBall.addChild(plume);


        cube_r5 = new CNAdvancedModelBox(this);
        ...
        cube_r6 = new CNAdvancedModelBox(this);
        ...
        plumeBlast = new CNAdvancedModelBox(this);
        ...
        plumeRing = new CNAdvancedModelBox(this);
        ...
        upperCloud = new CNAdvancedModelBox(this);
        ...
        upperCloud1 = new CNAdvancedModelBox(this);
        ...
        cube_r8 = new CNAdvancedModelBox(this);
        ...
        cube_r9 = new CNAdvancedModelBox(this);
        ...
        cube_r10 = new CNAdvancedModelBox(this);
        ...
        rings = new CNAdvancedModelBox(this);
        rings.setRotationPoint(0.0F, -55.0F, 0.0F);
        upperCloud.addChild(rings);


        upperRing = new CNAdvancedModelBox(this);
        ...
        lowerRing = new CNAdvancedModelBox(this);
    ...
    @Override
    public Iterable<CNBasicModelPart> parts() {
        return ImmutableList.of(mushroom_cloud);
    }

    @Override
    public Iterable<CNAdvancedModelBox> getAllParts() {
