...
public class CNPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> NITRATE_ORE = registerKey("nitrate_ore");
    ...
    public static void boostrap(BootstapContext<PlacedFeature> context) {
        ...
        Holder<ConfiguredFeature<?,?>> nitrateOre = featureLookup.getOrThrow(CNConfiguredFeatures.NITRATE_ORE_KEY);
        ...
        register(context, NITRATE_ORE, nitrateOre, placement(CountPlacement.of(6), -64,64));
