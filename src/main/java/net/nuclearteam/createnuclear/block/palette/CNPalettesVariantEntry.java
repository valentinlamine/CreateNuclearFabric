...
public class CNPalettesVariantEntry {
    ...
    public CNPalettesVariantEntry(String name, CNPalettesStoneTypes paletteStoneVariants) {
        ...
        for (CNPaletteBlockPattern pattern : paletteStoneVariants.variantTypes) {
