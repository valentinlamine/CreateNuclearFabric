...
public class IrradiatedPigModel<T extends IrradiatedPig> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition inside_d_r1 = ribs.addOrReplaceChild("inside_d_r1", CubeListBuilder.create().texOffs(25, 17).addBox(0.0F, -2.0F, -3.0F, 1.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, -16.0F, -1.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition inside_g_r1 = ribs.addOrReplaceChild("inside_g_r1", CubeListBuilder.create().texOffs(48, 17).addBox(-1.0F, -2.0F, -3.0F, 1.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, -16.0F, -1.0F, 0.0F, 3.1416F, 0.0F));
