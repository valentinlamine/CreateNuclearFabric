...
public class CNMenus {
    ...
    public static final MenuEntry<ConfiguredReactorItemMenu> REACTOR_BLUEPRINT_MENU = menu("reactor_blueprint_menu", ConfiguredReactorItemMenu::new, () -> ConfiguredReactorItemScreen::new);
